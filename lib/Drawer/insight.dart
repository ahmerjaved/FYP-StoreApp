          ...
          children: [
            ...
            RichText(
                ...
                text: TextSpan(children: <TextSpan>[
                  ...
                  TextSpan(text: (orderCount.totalRevenue != null) ? '$apCurrency ${orderCount.totalRevenue.toStringAsFixed(2)}' : '$apCurrency 0.0', style: Theme.of(context).textTheme.subtitle1.copyWith(height: 2)),
                ])),
            VerticalDivider(
              color: Colors.grey[400],
            ),
